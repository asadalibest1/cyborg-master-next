          ...
          <div className="feature-banner header-text">
            <div className="row">
              <div className="col-lg-4">
                <img src={featureLeftImg.src} alt="" style={{ borderRadius: '23px' }} />
              </div>
              <div className="col-lg-8">
                <div className="thumb">
                  <img src={featureRightImg.src} alt="" style={{ borderRadius: '23px' }} />
                  <a href="https://www.youtube.com/watch?v=r1b03uKWk_M" target="_blank" rel="noopener noreferrer"><i className="fa fa-play"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="content">
              <div className="row">
                ...
                <div className="col-lg-4">
                  <img src={details01Img.src} alt="" style={{ borderRadius: '23px', marginBottom: '30px' }} />
                </div>
                <div className="col-lg-4">
                  <img src={details02Img.src} alt="" style={{ borderRadius: '23px', marginBottom: '30px' }} />
                </div>
                <div className="col-lg-4">
                  <img src={details03Img.src} alt="" style={{ borderRadius: '23px', marginBottom: '30px' }} />
                </div>
                <div className="col-lg-12">
                  <p>Cyborg Gaming is free HTML CSS website template provided by TemplateMo. This is Bootstrap v5.2.0 layout. You can make a <a href="https://paypal.me/templatemo" target="_blank" rel="noopener noreferrer">small contribution via PayPal</a> to info [at] templatemo.com and thank you for supporting. If you want to get the PSD source files, please contact us. Lorem ipsum dolor sit consectetur es dispic dipiscingei elit, sed doers eiusmod lisum hored tempor.</p>
                </div>
                <div className="col-lg-12">
