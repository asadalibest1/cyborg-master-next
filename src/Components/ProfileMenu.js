                ...
                <div className="col-lg-4 align-self-center">
                    <div className="main-info header-text">
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <span>Offline</span>
                            <span style={{ cursor: 'pointer' }}><i className="fa fa-bookmark" aria-hidden="true"></i></span>
                        </div>
                        <h4>
                            <i className="fa fa-check" style={{ backgroundColor: '#e75e8d', borderRadius: '50%', fontSize: '22px', padding: '4px', paddingLeft: '3px' }}></i>
                            Alan Smithee
                        </h4>
                    ...
                    <div className="clips">
                        <div className="row">
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="item">
                                    <div className="thumb">
                                        <img src={clip01.src} alt="" style={{ borderRadius: '23px' }} />
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="item">
                                    <div className="thumb">
                                        <img src={clip02.src} alt="" style={{ borderRadius: '23px' }} />
                                        <a href="https://www.youtube.com/watch?v=r1b03uKWk_M" target="_blank"><i className="fa fa-play"></i></a>
                                    </div>
                                    <div className="down-content">
                                        <h4>Second Clip</h4>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="item">
                                    <div className="thumb">
                                        <img src={clip03.src} alt="" style={{ borderRadius: '23px' }} />
                                        <a href="https://www.youtube.com/watch?v=r1b03uKWk_M" target="_blank"><i className="fa fa-play"></i></a>
                                    </div>
                                    <div className="down-content">
                                        <h4>Third Clip</h4>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="item">
                                    <div className="thumb">
                                        <img src={clip04.src} alt="" style={{ borderRadius: '23px' }} />
                                        <a href="https://www.youtube.com/watch?v=r1b03uKWk_M" target="_blank"><i className="fa fa-play"></i></a>
                                    </div>
                                    <div className="down-content">
                                        <h4>Fourth Clip</h4>
