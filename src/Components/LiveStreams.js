                ...
                <div className="featured-games header-text">
                    ...
                    <div className="owl-features owl-carousel owl-loaded owl-drag">
                        <div className="owl-stage-outer">
                            <div className="owl-stage" style={{ transform: `translate3d(${translateX}px, 0px, 0px)`, transition: 'all 0.25s ease 0s', width: '2505px' }}>
                                <div className="owl-item cloned" style={{ width: '178.667px', marginRight: '30px' }}>
                                    <div className="item">
                                        <div className="thumb">
                        ...
                        <div className="owl-nav">
                            <button type="button" role="presentation" className="owl-prev" onClick={handlePrev}><span aria-label="Previous">‹</span></button>
                            <button type="button" role="presentation" className="owl-next" onClick={handleNext}><span aria-label="Next">›</span></button>
                        </div>
